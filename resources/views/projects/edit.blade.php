                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="project_number" name="project_number" type="text" class="mt-1 block w-full" :value="old('project_number', $project->project_number)" required />
                                </div>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="location" name="location" type="text" class="mt-1 block w-full" :value="old('location', $project->location)" />
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="description" name="description" rows="4" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-green-500 focus:ring-green-500">{{ old('description', $project->description) }}</textarea>
                                </div>
                            </div>
                        </div>
